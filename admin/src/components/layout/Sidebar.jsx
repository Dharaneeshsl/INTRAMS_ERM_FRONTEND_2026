  ...
  return (
    <div className="relative flex h-full flex-col bg-[rgba(11,17,28,0.96)]">
      <button
        ...
        onClick={onClose}
        className="absolute right-3 top-3 z-50 h-8 w-8 flex items-center justify-center rounded-md border border-white/6 bg-white/3 text-slate-200 hover:border-cyan-400/50"
      >
        <X className="h-4 w-4" />
      </button>
