      ...
      <div className="relative z-10 max-w-xl w-full mx-auto bg-white/95 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20 text-center">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full inline-flex items-center justify-center gap-2 py-3.5 bg-gradient-to-r from-accent-orange to-accent-yellow text-white font-semibold rounded-xl shadow-lg hover:from-orange-500 hover:to-yellow-500 transition-all disabled:opacity-50"
          >
